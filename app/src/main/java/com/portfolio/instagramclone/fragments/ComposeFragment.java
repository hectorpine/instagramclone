...
import com.portfolio.instagramclone.LoginActivity;
import com.portfolio.instagramclone.MainActivity;
...
import static com.portfolio.instagramclone.Post.KEY_IMAGE;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photoFile == null || ivPostImage.getDrawable() == null){
                    Toast.makeText(getContext(), "Theres no image!",Toast.LENGTH_SHORT).show();
                    return;
                }
